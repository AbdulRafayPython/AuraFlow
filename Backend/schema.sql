-- ============================================================
-- AuraFlow Database Schema
-- Engine : MySQL 9.2   Charset : utf8mb4
-- Sequence: FK-safe dependency order (parents before children)
-- ============================================================

SET FOREIGN_KEY_CHECKS = 0;

-- -----------------------------------------------------------
-- 1. users  (root table – no outbound FKs except self)
-- -----------------------------------------------------------
CREATE TABLE `users` (
...
-- -----------------------------------------------------------
-- 3. channels  (FK → communities, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 4. ai_agents  (standalone lookup table)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 5. agent_registry  (standalone lookup table)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 7. platform_settings  (standalone – no FK)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 8. community_members  (FK → communities, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 9. channel_members  (FK → channels, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 10. messages  (FK → channels, users, self)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 11. direct_messages  (FK → users, self)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 12. attachments  (FK → messages, direct_messages, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 13. message_reactions  (FK → messages, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 14. pinned_messages  (FK → channels, messages, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 15. dm_pinned_messages  (FK → users, direct_messages)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 16. direct_message_reactions  (FK → direct_messages, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 20. blocked_users  (FK → communities, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 22. push_subscriptions  (FK → users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 25. user_notification_settings  (FK → users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 26. ai_agent_logs  (FK → ai_agents, users, channels, messages)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 27. community_agents  (FK → communities, agent_registry, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 28. user_agents  (FK → users, agent_registry)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 30. user_moods  (FK → users, channels)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 31. conversation_summaries  (FK → channels, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 32. user_summary_schedules  (FK → users, channels)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 33. scheduled_summaries  (FK → user_summary_schedules, users, channels)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 35. voice_participants  (FK → voice_channels, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 36. voice_sessions  (FK → channels, users)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 37. channel_read_status  (FK → users, channels, messages)
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 38. community_unread_status  (FK → users, communities)
-- -----------------------------------------------------------
...
-- ============================================================
-- End of AuraFlow schema  (39 tables)
-- ============================================================
